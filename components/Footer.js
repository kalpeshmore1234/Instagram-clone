...
function Footer() {
  return (
    <div className='sticky w-full border-box bottom-0 h-16 sm:h-14 bg-red-500 sm:flex hidden items-center px-1.5 justify-between  border-b border-gray-200 rounded-sm mt-auto '>
